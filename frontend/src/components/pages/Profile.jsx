  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        {/* Navbar */}
        <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 px-2 sm:px-4 lg:px-8 py-2 sm:py-4">
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            <Logo variant="light" size="sm" className="flex-shrink-0" />
            <button 
              onClick={handleLogout}
              className="flex items-center gap-1 sm:gap-2 text-white hover:text-white/90 transition-colors border border-white/30 px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm rounded-lg hover:bg-white/10"
            >
