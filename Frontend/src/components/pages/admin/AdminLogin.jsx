...
import { Shield, Mail, Lock, ArrowRight, ArrowLeft, Sparkles } from 'lucide-react';
...
export default function AdminLogin() {
  ...
  const { loginAdmin, admin, isLoading } = useAdminAuth();
  ...
  const handleSubmit = (e) => {
    ...
    if (loginAdmin(email, password)) {
      ...
      setError('Invalid credentials. Use admin@livesync.com / admin123');
    }
  };
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          ...
          >
            ...
            <div className="mt-6 p-4 bg-white/5 rounded-2xl text-sm border border-white/10">
              <p className="text-white/70 font-medium">Demo Credentials:</p>
              <p className="text-white/80 font-mono mt-2">Email: admin@livesync.com</p>
